    ...
    >
      ...
      <div className="mt-4">
        <p className="text-pretty text-sm text-gray-500">
          "Partnering with this team was a game-changer for our business.
          Their expertise in system, web, and mobile app development brought our
          vision to life with seamless, high-quality solutions. We highly recommend
          them for any digital transformation needs.
        </p>
